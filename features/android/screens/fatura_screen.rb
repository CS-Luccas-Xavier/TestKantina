class FaturaScreen < AndroidScreenBase
  ...
  def invoice_true
    system("curl -X PATCH -d '{\"paid\":true, \"value\": 12.21}' 'https://kantina-3606f.firebaseio.com/desenvolvimento/usuarios/Luccas Xavier/invoices/previous.json'")
    sleep(4)
  end

  def invoice_false
    system("curl -X PATCH -d '{\"paid\":false, \"value\": 12.21}'  'https://kantina-3606f.firebaseio.com/desenvolvimento/usuarios/Luccas Xavier/invoices/previous.json'")
    sleep(4)
  end
